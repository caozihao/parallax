(function (e, t, n) {
  ...
  function r(e, t, n) {
    var r = e.runtimeStyle && e.runtimeStyle[t],
      i, s = e.style;
    return !/^-?[0-9]+\.?[0-9]*(?:px)?$/i.test(n) && /^-?\d/.test(n) && (i = s.left, r && (e.runtimeStyle.left = e.currentStyle.left), s.left = t === "fontSize" ? "1em" : n || 0, n = s.pixelLeft + "px", s.left = i, r && (e.runtimeStyle.left = r)),
  ...
  function o(e, t, n, r, i, s) {
    ...
    if (o[0].toString().indexOf("%") !== -1) l = parseFloat(o[0]) / 100,
      a = n.width * l,
      e !== "backgroundSize" && (a -= (s || r).width * l);
    ...
    return o[1] === "auto" ? u = a / r.width * r.height : o[1].toString().indexOf("%") !== -1 ? (l = parseFloat(o[1]) / 100, u = n.height * l, e !== "backgroundSize" && (u -= (s || r).height * l)) : u = parseInt(o[1], 10),
      [a, u]
  }
  function u(e, t) {
    var n = [];
  ...
  f.Util = {},
    ...
    f.Util.Bounds = function (e) {
      var t, n = {};
      return e.getBoundingClientRect && (t = e.getBoundingClientRect(), n.top = t.top, n.bottom = t.bottom || t.top + t.height, n.left = t.left, n.width = e.offsetWidth, n.height = e.offsetHeight),
        n
    },
    ...
    f.Util.Children = function (e) {
      ...
      try {
        t = e.nodeName && e.nodeName.toUpperCase() === "IFRAME" ? e.contentDocument || e.contentWindow.document : function (e) {
          ...
          return e !== null &&
            function (e, t) {
              var r = e.length,
                i = 0;
              if (typeof t.length == "number") for (var s = t.length; i < s; i++) e[r++] = t[i];
        ...
        f.Util.log("html2canvas.Util.Children failed with exception: " + r.message),
          t = []
      }
      return t
    },
    ...
    f.Util.Font = function () {
      ...
      return function (t, r, i) {
        ...
        return s.style.visibility = "hidden",
          ...
          o.src = "data:image/gif;base64,R0lGODlhAQABAIABAP///wAAACwAAAAAAQABAAACAkQBADs=",
          o.width = 1,
          o.height = 1,
          o.style.margin = 0,
          o.style.padding = 0,
          ...
          u.style.margin = 0,
          u.style.padding = 0,
          u.appendChild(i.createTextNode(a)),
          s.appendChild(u),
          s.appendChild(o),
          f = o.offsetTop - u.offsetTop + 1,
          s.removeChild(u),
          s.appendChild(i.createTextNode(a)),
          s.style.lineHeight = "normal",
          o.style.verticalAlign = "super",
          l = o.offsetTop - s.offsetTop + 1,
          c = {
            baseline: f,
            lineWidth: 1,
            middle: l
      ...
      r.parseGradient = function (e, t) {
        ...
        if (o) switch (o[1]) {
          ...
          case "-o-linear-gradient":
            ...
            n.x0 === null && n.x1 === null && (n.x0 = n.x1 = t.width / 2),
              n.y0 === null && n.y1 === null && (n.y0 = n.y1 = t.height / 2),
              a = o[3].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)(?:\s\d{1,3}(?:%|px))?)+/g);
            if (a) {
              f = a.length,
                l = 1 / Math.max(f - 1, 1);
              for (r = 0; r < f; r += 1) c = a[r].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/),
                c[2] ? (u = parseFloat(c[2]), c[3] === "%" ? u /= 100 : u /= t.width) : u = r * l,
                n.colorStops.push({
                  color: c[1],
                  stop: u
                })
          ...
          case "-webkit-gradient":
            n = {
              ...
              a && (n.x0 = a[1] * t.width / 100, n.y0 = a[2] * t.height / 100, n.x1 = a[3] * t.width / 100, n.y1 = a[4] * t.height / 100),
              a = o[4].match(/((?:from|to|color-stop)\((?:[0-9\.]+,\s)?(?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)\))+/g);
            if (a) {
              f = a.length;
              for (r = 0; r < f; r += 1) c = a[r].match(/(from|to|color-stop)\(([0-9\.]+)?(?:,\s)?((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\)/),
                u = parseFloat(c[2]),
                c[1] === "from" && (u = 0),
                c[1] === "to" && (u = 1),
                n.colorStops.push({
          ...
          case "-moz-linear-gradient":
            n = {
              ...
              a && (n.x0 = a[1] * t.width / 100, n.y0 = a[2] * t.height / 100, n.x1 = t.width - n.x0, n.y1 = t.height - n.y0),
              a = o[3].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\)(?:\s\d{1,3}%)?)+/g);
            if (a) {
              f = a.length,
                l = 1 / Math.max(f - 1, 1);
              for (r = 0; r < f; r += 1) c = a[r].match(/((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%)?/),
                c[2] ? (u = parseFloat(c[2]), c[3] && (u /= 100)) : u = r * l,
                n.colorStops.push({
                  color: c[1],
                  stop: u
                })
          ...
          case "-o-radial-gradient":
            n = {
              ...
              a = o[2].match(/(\d{1,3})%?\s(\d{1,3})%?/),
              a && (n.cx = a[1] * t.width / 100, n.cy = a[2] * t.height / 100),
              a = o[3].match(/\w+/),
              c = o[4].match(/[a-z\-]*/);
            if (a && c) switch (c[0]) {
              ...
              case "":
                h = Math.sqrt(Math.pow(n.cx, 2) + Math.pow(n.cy, 2)),
                  p = Math.sqrt(Math.pow(n.cx, 2) + Math.pow(n.y1 - n.cy, 2)),
                  d = Math.sqrt(Math.pow(n.x1 - n.cx, 2) + Math.pow(n.y1 - n.cy, 2)),
                  v = Math.sqrt(Math.pow(n.x1 - n.cx, 2) + Math.pow(n.cy, 2)),
                  n.rx = n.ry = Math.max(h, p, d, v);
                break;
              case "closest-corner":
                h = Math.sqrt(Math.pow(n.cx, 2) + Math.pow(n.cy, 2)),
                  p = Math.sqrt(Math.pow(n.cx, 2) + Math.pow(n.y1 - n.cy, 2)),
        ...
        r.Gradient = function (n, r) {
          ...
          i.width = r.width,
            i.height = r.height,
            o = f.Generate.parseGradient(n, r);
          if (o) switch (o.type) {
            case "linear":
              u = s.createLinearGradient(o.x0, o.y0, o.x1, o.y1),
                o.colorStops.forEach(e(u)),
                s.fillStyle = u,
                s.fillRect(0, 0, r.width, r.height);
              break;
            case "circle":
              u = s.createRadialGradient(o.cx, o.cy, 0, o.cx, o.cy, o.rx),
                o.colorStops.forEach(e(u)),
                s.fillStyle = u,
                s.fillRect(0, 0, r.width, r.height);
              break;
            case "ellipse":
              var a = t.createElement("canvas"),
                ...
                h = c * 2;
              a.width = a.height = h,
                u = l.createRadialGradient(o.rx, o.ry, 0, o.rx, o.ry, c),
                o.colorStops.forEach(e(u)),
                l.fillStyle = u,
                l.fillRect(0, 0, h, h),
                s.fillStyle = o.colorStops[o.colorStops.length - 1].color,
                s.fillRect(0, 0, i.width, i.height),
                s.drawImage(a, o.cx - o.rx, o.cy - o.ry, 2 * o.rx, 2 * o.ry)
          }
          return i
        },
        ...
        r.ListRoman = function (e) {
          ...
          for (i = 0; i < s; i += 1) while (e >= n[i]) e -= n[i],
            r += t[i];
          return r
        }
    }(),
    f.Parse = function (r, i) {
      ...
      function m(e, t, n, r) {
        ...
        e.setVariable("fillStyle", r),
          e.setVariable("font", [vt(t, "fontStyle"), vt(t, "fontVariant"), s, u, o].join(" ")),
          e.setVariable("textAlign", i ? "right" : "left"),
          a.length && (e.setVariable("shadowColor", a[0].color), e.setVariable("shadowOffsetX", a[0].offsetX), e.setVariable("shadowOffsetY", a[0].offsetY), e.setVariable("shadowBlur", a[0].blur));
      ...
      function S(e, t) {
        ...
        return n.style.display = "inline",
          ...
          n.appendChild(lt.createTextNode(t)),
      ...
      function L(e, t, n) {
        ...
        t.zIndex = r = a(s),
          ...
          r.isFloated = u,
          r.opacity = o,
          r.ownStacking = s !== "auto" || o < 1,
          n && n.zIndex.children.push(t)
      }
      ...
      function D(e, t, n, r, i, s, o) {
        t[0] > 0 || t[1] > 0 ? (e.push(["line", r[0].start.x, r[0].start.y]), r[0].curveTo(e), r[1].curveTo(e)) : e.push(["line", s, o]),
          (n[0] > 0 || n[1] > 0) && e.push(["line", i[0].start.x, i[0].start.y])
      }
      function P(e, t, n, r, i, s, o) {
        var u = [];
        return t[0] > 0 || t[1] > 0 ? (u.push(["line", r[1].start.x, r[1].start.y]), r[1].curveTo(u)) : u.push(["line", e.c1[0], e.c1[1]]),
          n[0] > 0 || n[1] > 0 ? (u.push(["line", s[0].start.x, s[0].start.y]), s[0].curveTo(u), u.push(["line", o[0].end.x, o[0].end.y]), o[0].curveToReversed(u)) : (u.push(["line", e.c2[0], e.c2[1]]), u.push(["line", e.c3[0], e.c3[1]])),
          t[0] > 0 || t[1] > 0 ? (u.push(["line", i[1].end.x, i[1].end.y]), i[1].curveToReversed(u)) : u.push(["line", e.c4[0], e.c4[1]]),
          u
      }
      function H(e, t, n) {
        var r = e.left,
        ...
        switch (s) {
          ...
          case "padding-box":
            D(o, r[0], r[1], t.topLeftInner, t.topRightInner, i.left + n[3].width, i.top + n[0].width),
              D(o, r[1], r[2], t.topRightInner, t.bottomRightInner, i.left + i.width - n[1].width, i.top + n[0].width),
              D(o, r[2], r[3], t.bottomRightInner, t.bottomLeftInner, i.left + i.width - n[1].width, i.top + i.height - n[2].width),
              D(o, r[3], r[0], t.bottomLeftInner, t.topLeftInner, i.left + n[3].width, i.top + i.height - n[2].width);
            break;
          default:
            D(o, r[0], r[1], t.topLeftOuter, t.topRightOuter, i.left, i.top),
              D(o, r[1], r[2], t.topRightOuter, t.bottomRightOuter, i.left + i.width, i.top),
              D(o, r[2], r[3], t.bottomRightOuter, t.bottomLeftOuter, i.left + i.width, i.top + i.height),
              D(o, r[3], r[0], t.bottomLeftOuter, t.topLeftOuter, i.left, i.top + i.height)
        }
        return o
      }
      function j(e, t, n) {
      ...
      function q(e, t, n) {
        ...
        r.style.top = t.top + "px",
          ...
          s = e.nodeName === "SELECT" ? (e.options[e.selectedIndex] || 0).text : e.value,
          s || (s = e.placeholder),
          o = lt.createTextNode(s),
          r.appendChild(o),
          dt.appendChild(r),
          E(e, o, n),
          dt.removeChild(r)
      ...
      function U(n, r) {
        ...
        return a.className = mt + "-before " + mt + "-after",
          Object.keys(i).filter(z).forEach(function (e) {
            try {
              a.style[e] = i[e]
            } catch (t) {
          ...
          u ? a.src = ct.parseBackgroundImage(s)[0].args[0] : a.innerHTML = s,
          a
      }
      function z(t) {
      ...
      function W(e, t) {
        var n = U(e, ":before"),
          r = U(e, ":after");
        if (!n && !r) return;
        n && (e.className += " " + mt + "-before", e.parentNode.insertBefore(n, e), st(n, t, !0), e.parentNode.removeChild(n), e.className = e.className.replace(mt + "-before", "").trim()),
          r && (e.className += " " + mt + "-after", e.appendChild(r), st(r, t, !0), e.removeChild(r), e.className = e.className.replace(mt + "-after", "").trim())
      }
      function X(e, t, n, r) {
      ...
      function K(e, t, n) {
        ...
        while (o--) {
          ...
          s = C(u),
            s ? J(e, t, n, s, o) : ct.log("html2canvas: Error loading background:", r)
        }
      }
      function Q(e, t) {
        ...
        return r.width = t.width,
          r.height = t.height,
          n = r.getContext("2d"),
          R(n, e, 0, 0, e.width, e.height, 0, 0, t.width, t.height),
          r
      }
      function G(e, t, n) {
      ...
      function et(e, t, n, r) {
        ...
        return L(e, f, t),
          i.useOverflow === !0 && /(hidden|scroll|auto)/.test(vt(e, "overflow")) === !0 && /(BODY)/i.test(e.nodeName) === !1 && (f.clip = f.clip ? k(f.clip, n) : n),
          f
      }
      function tt(e, t, n) {
        var r = {
      ...
      function rt(e, t, n, r) {
        ...
        F(f, c.clip),
          f.save(),
          f.clip(),
          l.height > 0 && l.width > 0 && !r ? ($(f, s, h), K(e, l, f)) : r && (u.backgroundColor = h),
          f.restore(),
          c.borders.forEach(function (e) {
            I(f, e.args, e.color)
          }),
          n || W(e, u);
        switch (e.nodeName) {
      ...
      gt.innerHTML = "." + mt + '-before:before { content: "" !important; display: none !important; }' + "." + mt + '-after:after { content: "" !important; display: none !important; }',
        dt.appendChild(gt),
        r = r || {};
      var yt = function (e) {
    ...
    f.Preload = function (r) {
      ...
      function s() {
        g.log("html2canvas: start: images: " + v.numLoaded + " / " + v.numTotal + " (failed: " + v.numFailed + ")"),
          !v.firstRun && v.numLoaded >= v.numTotal && (g.log("Finished loading images: # " + v.numTotal + " (failed: " + v.numFailed + ")"), typeof r.complete == "function" && r.complete(v))
      }
      function o(t, i, o) {
        var u, a = r.proxy,
          f;
        N.href = t,
          ...
          o.callbackname = u,
          a.indexOf("?") > -1 ? a += "&" : a += "?",
          a += "url=" + encodeURIComponent(t) + "&callback=" + u,
          f = S.createElement("script"),
          e[u] = function (t) {
            t.substring(0, 6) === "error:" ? (o.succeeded = !1, v.numLoaded++ , v.numFailed++ , s()) : (d(i, o), i.src = t),
              e[u] = n;
            try {
              delete e[u]
            } catch (r) { }
      ...
      function u(t, n) {
        var r = e.getComputedStyle(t, n),
          i = r.content;
        i.substr(0, 3) === "url" && y.loadImage(f.Util.parseBackgroundImage(i)[0].args[0]),
          h(r.backgroundImage, t)
      }
      function a(e) {
        u(e, ":before"),
          u(e, ":after")
      ...
      function p(e) {
        ...
        try {
          ...
          t = !1,
            g.log("html2canvas: failed to access some element's nodeType - Exception: " + i.message)
        }
        if (t === 1 || t === n) {
          a(e);
          try {
      ...
      function d(t, i) {
        t.onload = function () {
          i.timer !== n && e.clearTimeout(i.timer),
            v.numLoaded++ ,
            i.succeeded = !0,
      ...
      N.href = e.location.href,
              ...
              for (u in v) if (v.hasOwnProperty(u)) {
                ...
                if (typeof o == "object" && o.callbackname && o.succeeded === n) {
                  ...
                  o.script && o.script.parentNode && (o.script.setAttribute("src", "about:blank"), o.script.parentNode.removeChild(o.script)),
                    v.numLoaded++ ,
                    v.numFailed++ ,
                    g.log("html2canvas: Cleaned up failed img: '" + u + "' Steps: " + v.numLoaded + " / " + v.numTotal)
                }
              }
              e.stop !== n ? e.stop() : t.execCommand !== n && t.execCommand("Stop", !1),
                t.close !== n && t.close(),
                v.cleanupDone = !0,
                (!i || typeof i != "string") && s()
            }
        ...
        r.timeout > 0 && (k = e.setTimeout(y.cleanupDOM, r.timeout)),
        g.log("html2canvas: Preload starts: finding background-images"),
        v.firstRun = !0,
        p(E),
        g.log("html2canvas: Preload: Finding images");
      for (b = 0; b < T; b += 1) y.loadImage(x[b].getAttribute("src"));
      return v.firstRun = !1,
        g.log("html2canvas: Preload: Done."),
        v.numTotal === v.numLoaded && s(),
        y
    },
      ...
      function i(e) {
        ...
        return i = function (e) {
          function t(e, r, i) {
            ...
            s === 0 && i ? i.push(f) : (e[s] || (e[s] = []), e[s].push(f)),
    ...
    f.Util.Support = function (e, t) {
      function r() {
        ...
        return f.Util.log("html2canvas: Parse: SVG powered rendering available"),
          !0
      }
      function i() {
        var e, n, r, i, s = !1;
        return t.createRange && (e = t.createRange(), e.getBoundingClientRect && (n = t.createElement("boundtest"), n.style.height = "123px", n.style.display = "block", t.body.appendChild(n), e.selectNode(n), r = e.getBoundingClientRect(), i = r.height, i === 123 && (s = !0), t.body.removeChild(n))),
          s
      }
      return {
        rangeBounds: i(),
    ...
    e.html2canvas = function (t, n) {
      ...
      return s = f.Util.Extend(n, s),
        ...
        s.complete = function (e) {
          ...
          i = f.Renderer(r, s),
            typeof s.onrendered == "function" && s.onrendered(i)
        },
    ...
    f.Renderer.Canvas = function (e) {
      ...
      function i(e) {
        if (u.indexOf(e.arguments[0].src) === -1) {
          ...
          try {
            ...
            return a = o.createElement("canvas"),
              l = a.getContext("2d"),
              !1
          }
      ...
      return function (e, t, r, i, o) {
        var u = h.getContext("2d"),
          a, f, l, p = e.stack;
        return h.width = h.style.width = t.width || p.ctx.width,
          h.height = h.style.height = t.height || p.ctx.height,
          l = u.fillStyle,
          u.fillStyle = c.isTransparent(p.backgroundColor) && t.background !== n ? t.background : e.backgroundColor,
          u.fillRect(0, 0, h.width, h.height),
          u.fillStyle = l,
          i.forEach(function (e) {
            u.textBaseline = "bottom",
              u.save(),
              e.transform.matrix && (u.translate(e.transform.origin[0], e.transform.origin[1]), u.transform.apply(u, e.transform.matrix), u.translate(-e.transform.origin[0], -e.transform.origin[1])),
              e.clip && (u.beginPath(), u.rect(e.clip.left, e.clip.top, e.clip.width, e.clip.height), u.clip()),
          ...
          t.elements.length === 1 && typeof t.elements[0] == "object" && t.elements[0].nodeName !== "BODY" ? (f = o.Util.Bounds(t.elements[0]), a = r.createElement("canvas"), a.width = Math.ceil(f.width), a.height = Math.ceil(f.height), u = a.getContext("2d"), u.drawImage(h, f.left, f.top, f.width, f.height, 0, 0, f.width, f.height), h = null, a) : h
      }
    }
})(window, document);
var detectEdge = function () {
    ...
    for (var m = 1; m < p; ++m) {
      ...
      for (var H = 1; H < d; ++H) {
        ...
        w = C,
          ...
          D = f[++b],
          P = -M - _ - D,
          s ? (factor = .3 * (B + C) + .59 * (j + O) + .11 * (F + P), l[h] = factor, l[++h] = factor, l[++h] = factor) : (l[h] = B + C, l[++h] = j + O, l[++h] = F + P),
          l[++h] = 255,
          ++h
      }
      h += 8
  ...
  function t(t) {
    var n = t.width,
      ...
      s = i.data,
      o = 0;
    for (var u = 0; u < r; ++u) for (var a = 0; a < n; ++a) s[o] < 240 ? (s[o] = 0, s[++o] = 0, s[++o] = 0) : (s[o] = 255, s[++o] = 255, s[++o] = 255),
      s[++o] = 255,
      ++o;
    return i
  }
...
Animation = function () {
  ...
  Snowflakes = function () {
    ...
    function e(e, n) {
      ...
      r.onload = function () {
        for (var i = 0; i < h; i++) {
          ...
          a.drawImage(r, i * p, 0, p, d, 0, 0, p, d),
            c.push(s)
        }
        e && (u = e),
          n || (o = []);
    ...
    function n(e) {
      P.globalAlpha = e.o,
        P.drawImage(c[e.si], 0, 0, p, d, e.x, e.y, e.sw, e.sh)
    }
    function r() {
      for (var e = 0; e < o.length; e++) {
        ...
        t.o > N && (t.o = N),
          t.o < T && (t.o = T);
        var u = !1;
        t.y > v.height + d / 2 && (t.y = 0, u = !0),
          t.y < 0 && (t.y = v.height, u = !0),
          t.x > v.width + p / 2 && (t.x = 0, u = !0),
          t.x < 0 && (t.x = v.width, u = !0),
          u && (t.nl = !1)
      }
    }
    function i(e) {
      ...
      for (var t = 0; t < o.length; t++) {
        var n = o[t];
        e.globalAlpha = n.o,
          e.drawImage(c[n.si], 0, 0, p, d, n.x, n.y, n.sw, n.sh)
      }
    }
    function s(t) {
      ...
      v.width = t.cw,
        ...
        P = D.getContext("2d"),
        B = H.getContext("2d"),
        D.width = H.width = t.cw,
        D.height = H.height = t.ch,
        j = t.dropPoints,
        F = t.dropCount,
        I = t.maxPointDrop,
        Animation.addFrameRenderer(i, B),
        Animation.start()
    }
    var o = [],
      u = 1,
      a = .1,
      f = 2,
      l = "ht" + "tp://ho" + "vertree.c" + "om/hvti" + "mg/201512/ph2aerfy.p" + "ng",
      c = [],
      h = 5,
      p = 20,
      d = 20,
